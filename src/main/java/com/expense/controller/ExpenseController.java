...
public class ExpenseController {
	...
	// MyBookList mb=new
	// MyBookList(b.getId(),b.getAmount(),b.getCurrency(),b.getDate());
	...
	@RequestMapping(value = "/available_expenses/editExpense/update/{id}", method = { RequestMethod.GET,
			RequestMethod.PUT })
	...
	@GetMapping("/entries")
	public ModelAndView getFilteredEntries(@RequestParam(required = false) Integer month,
			@RequestParam(required = false) Integer year, Principal p, Model model) {
		String email = p.getName();
	...
	@GetMapping("/chart")
	public String generateExpenseChart(@RequestParam(value = "year", required = false) Integer year, Model model) {
		if (year == null) {
			return "chart";
		}
